...
const Contact = () => {
  return (
    <section
      id="contact"
      className="w-full min-h-screen bg-[#0f0f0f] text-[#f1f1f1] py-16 px-4 sm:px-6 lg:px-8 relative"
    >
      {/* Glow Background */}
      <div className="absolute w-[600px] h-[600px] sm:w-[800px] sm:h-[800px] bg-[#ff5f5f] opacity-10 rounded-full blur-[200px] z-0 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" />

      <div className="relative z-10 max-w-6xl mx-auto">
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-center mb-4 bg-gradient-to-r from-[#ff5f5f] to-[#00d2ff] text-transparent bg-clip-text">
          Let's Work Together
        </h2>
        <p className="text-center text-base sm:text-lg text-[#ccc] mb-12 px-2 sm:px-10">
          I’m currently{" "}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
          {/* Contact Form */}
          <form className="bg-white/5 p-6 sm:p-8 rounded-lg backdrop-blur-md border border-white/10 shadow-md space-y-6">
            <div>
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left space-y-6 px-4">
            <p className="text-[#ddd] text-base sm:text-lg leading-relaxed">
              If you’d prefer, you can also reach out via any of my socials
              below. I usually respond within a day!
            </p>

            <div className="flex gap-6 text-2xl text-[#f1f1f1] justify-center md:justify-start">
              <a
